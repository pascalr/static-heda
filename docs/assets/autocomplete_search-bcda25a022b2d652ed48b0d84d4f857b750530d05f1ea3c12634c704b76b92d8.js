(() => {
  ...
  var require_auto_complete = __commonJS({
    "node_modules/js-autocomplete/auto-complete.js"(exports, module) {
  ...
  // app/javascript/autocomplete_search.js
  var import_jquery = __toESM(require_jquery());
  var import_auto_complete2 = __toESM(require_auto_complete());
  document.addEventListener("DOMContentLoaded", function(event) {
    var elements = document.querySelectorAll("[data-autocomplete-url]");
    for (const elem of elements) {
      import_jquery.default.get(elem.dataset.autocompleteUrl, function(choices) {
        new import_auto_complete2.default({
          selector: elem,
          minChars: 1,
 ...
 */
//# sourceMappingURL=/assets/autocomplete_search.js-718fd577edc92b1a7ee121bd77e586a9929557fafa0ed95bbe9b5c75629fd79d.map
//!
;
