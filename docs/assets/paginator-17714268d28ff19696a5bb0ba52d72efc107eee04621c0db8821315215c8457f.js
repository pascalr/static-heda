(() => {
  ...
  document.addEventListener("DOMContentLoaded", function(event) {
    ...
    if (previous == null) {
      previous = createMissingLink(false);
    }
    previous.addEventListener("click", function(evt) {
      evt.preventDefault();
      if (gon.current_page == 1) {
        return;
      }
    ...
    if (next == null) {
      next = createMissingLink(true);
    }
    next.addEventListener("click", function(evt) {
      evt.preventDefault();
      if (gon.current_page == gon.pages.length) {
        return;
      }
...
//# sourceMappingURL=/assets/paginator.js-b237e325b470b7edf4101722a014e7ce2b0d135e6ddbf8e17115bfffd8b1b6b9.map
//!
;
